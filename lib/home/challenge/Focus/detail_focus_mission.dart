...
import 'package:flutter_application_test/home/challenge/DeadLine/deadline_mission_card.dart';
import 'package:flutter_application_test/home/challenge/DeadLine/mission_type_button.dart';
...
class DetailFocusMission extends StatefulWidget {
  const DetailFocusMission({super.key});

  @override
  _DetailFocusMissionState createState() => _DetailFocusMissionState();
}

class _DetailFocusMissionState extends State<DetailFocusMission> {
  // 미션 종류 선택 버튼의 선택 상태
