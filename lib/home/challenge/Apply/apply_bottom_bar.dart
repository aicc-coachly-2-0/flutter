...
import 'package:flutter_application_test/home/challenge/Apply/apply_complete.dart';
import 'package:flutter_application_test/home/challenge/Apply/post_api_mission.dart'; // joinMission 함수
import 'package:flutter_application_test/home/challenge/all_mission_get.dart'; // Mission 모델
import 'package:flutter_riverpod/flutter_riverpod.dart';

class ApplyBottomBar extends ConsumerStatefulWidget {
  final Mission mission; // 참여하려는 미션의 room_number를 전달

  const ApplyBottomBar({super.key, required this.mission});

  @override
  _ApplyBottomBarState createState() => _ApplyBottomBarState();
}

class _ApplyBottomBarState extends ConsumerState<ApplyBottomBar> {
              ...
              onPressed: (isChecked1 && isChecked2)
                  ? () async {
                      ...
                      try {
                        // joinMission 함수 호출
                        await joinMission(
                            ref, widget.mission.roomNumber); // 미션 참여하기
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('미션 참여 실패: ${e.toString()}')),
                        );
                      }
                    }
