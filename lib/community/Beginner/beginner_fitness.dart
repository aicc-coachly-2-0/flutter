...
class BeginnerFitness extends StatefulWidget {
  const BeginnerFitness({super.key});

  @override
  _BeginnerFitnessState createState() => _BeginnerFitnessState();
}

final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

class _BeginnerFitnessState extends State<BeginnerFitness> {
  List<Post> posts = [];
  int currentPage = 1;
