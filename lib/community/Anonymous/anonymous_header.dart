...
class AnonymousHeader extends ConsumerWidget {
  final Post post;
  final User user;

  const AnonymousHeader({super.key, required this.post, required this.user});
          ...
          return Row(
            children: [
              ...
              GestureDetector(
                ...
                radius: 25,
                backgroundColor:
                    Color.fromARGB(255, 255, 173, 166), // 배경 색상 (이미지가 없을 때 사용)
                child: Icon(
