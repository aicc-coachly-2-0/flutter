...
import 'package:flutter_application_test/community/Anonymous/anonymous_comments.dart';
import 'package:flutter_application_test/community/Anonymous/anonymous_header.dart';
import 'package:flutter_application_test/community/Anonymous/anonymous_image.dart';
...
class AnonymousPost extends ConsumerStatefulWidget {
  final Post post;

  const AnonymousPost({super.key, required this.post});

  @override
  _AnonymousPostState createState() => _AnonymousPostState();
}

class _AnonymousPostState extends ConsumerState<AnonymousPost> {
  bool isLiked = false;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              AnonymousHeader(post: post, user: user),
