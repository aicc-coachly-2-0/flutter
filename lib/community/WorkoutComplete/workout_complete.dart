...
import 'package:flutter_application_test/community/WorkoutComplete/workout_complete_section.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              // 게시글 목록 섹션
              WorkoutCompleteSection(), // 페이징된 게시글을 전달
              const SizedBox(height: 20),
              // 페이지네이션 섹션
              PaginationSection(
