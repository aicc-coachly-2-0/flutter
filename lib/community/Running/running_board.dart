...
import 'package:flutter_application_test/community/Running/running_section.dart';
...
class RunningBoard extends StatefulWidget {
  const RunningBoard({super.key});

  @override
  _RunningBoardState createState() => _RunningBoardState();
}

final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

class _RunningBoardState extends State<RunningBoard> {
  List<Post> posts = [];
  int currentPage = 1;
