...
import 'package:flutter_application_test/community/Mission/fitness_challenge_section.dart';
...
class FitnessChallenge extends StatefulWidget {
  ...
  @override
  _FitnessChallengeState createState() => _FitnessChallengeState();
}

final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();

class _FitnessChallengeState extends State<FitnessChallenge> {
  List<Post> posts = [];
  int currentPage = 1;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              // 게시글 목록 섹션
              FitnessChallengeSection(), // 페이징된 게시글을 전달
              const SizedBox(height: 20),
              // 페이지네이션 섹션
              PaginationSection(
